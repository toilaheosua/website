...
- **Viết bài thủ công**: Nội dung → "+ Viết bài thủ công": tiêu đề, đường dẫn (tự tạo nếu trống), meta, từ khóa, tóm tắt nhanh, nội dung markdown (mỗi "## " là một mục), FAQ. Bài tự viết đăng ngay, cổng kiểm duyệt chỉ ghi góp ý. Bài blog có nút "Soạn thảo bài (markdown)" để sửa lại theo cùng form, và nút "Xóa" (xóa bài, ảnh của bài và mục trong kế hoạch; đường dẫn cũ báo 404).
