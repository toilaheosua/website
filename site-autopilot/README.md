...
- **Chọn ảnh từng vị trí**: trang site → Ảnh trên website → mỗi vị trí (đầu trang chủ, giới thiệu, từng dịch vụ, từng bài, ảnh trong mục) chọn ảnh trong kho theo số thứ tự, tải ảnh mới thẳng vào vị trí, hoặc "Bỏ ảnh, để trống". Ảnh chọn tay được giữ nguyên khi hệ thống gán lại ảnh hàng loạt.
