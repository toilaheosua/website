...
- **Thiết kế trang chủ** (nút tím trong trang site): trang chủ được ghép từ các khối (đầu trang, mục nội dung AI viết, dịch vụ, bài viết mới, FAQ, dải kêu gọi, khối chữ tự do, ảnh + chữ, bộ sưu tập ảnh từ kho, thông tin liên hệ). Kéo thả để đổi thứ tự, bấm vào khối để chỉnh (kiểu hero, cách trình bày mục, ảnh, số cột...), ẩn hoặc xóa, thêm khối mới; cột bên phải xem trước tức thì kể cả bản điện thoại. Cùng trang có đổi bảng màu, từng màu, cặp font, bo góc, kiểu header, kiểu hero, kiểu thẻ. "Lưu và dựng lại" ghi bố cục vào sites.layout và theme, rồi dựng lại; "Về bố cục mặc định" quay về thứ tự theo theme. Site chưa tùy chỉnh dựng y như trước (bố cục mặc định suy ra từ theme.sectionOrder).
...
- **Viết bài thủ công**: Nội dung → "+ Viết bài thủ công": tiêu đề, đường dẫn (tự tạo nếu trống), meta, từ khóa, tóm tắt nhanh, nội dung markdown (mỗi "## " là một mục), FAQ. Bài tự viết đăng ngay, cổng kiểm duyệt chỉ ghi góp ý. Ảnh trong bài: tải vào Kho ảnh thật rồi bấm "Chèn ảnh từ kho" ngay dưới ô nội dung (chèn dạng ![alt](/assets/img/lib-xxx.webp)); đường dẫn ảnh không có trên website (như photos/anh.jpg từ công cụ khác) bị chặn khi lưu, ảnh ngoài dùng https:// đầy đủ. Bài blog có nút "Soạn thảo bài (markdown)" để sửa lại theo cùng form, và nút "Xóa" (xóa bài, ảnh của bài và mục trong kế hoạch; đường dẫn cũ báo 404).
- **Nhập bài từ file**: Nội dung → "Nhập bài từ file": chọn ZIP xuất từ công cụ soạn bài (bài .md hoặc .json cùng thư mục ảnh) hoặc một file .md / .json / .txt. Hệ thống tự nhận diện tiêu đề, H1, meta, từ khóa, đường dẫn (front matter), tóm tắt nhanh, các mục, mục Câu hỏi thường gặp thành FAQ, đưa ảnh trong bài vào Kho ảnh thật (tag nhap-bai) và thay đường dẫn ảnh, ảnh đầu tiên làm ảnh đầu bài. Kết quả điền sẵn vào form soạn bài để xem lại rồi Đăng. Đọc ZIP bằng mã có sẵn (src/core/zip.ts), không cần thư viện ngoài.
- **Thông tin SEO thủ công**: trong chi tiết trang có form Title, Đường dẫn (chỉ bài blog đổi được), Meta description, H1, Từ khóa, Alt ảnh đầu trang, Mô tả ngắn. Lưu là dựng lại.
- **Sinh lại một trang**: Nội dung → Sinh lại. Hoặc sửa JSON trực tiếp rồi Lưu.
- **Bộ Câu Hỏi** (tab cạnh Entity SEO): 30 câu phỏng vấn chủ doanh nghiệp theo 8 nhóm (tổng quan, sản phẩm/dịch vụ, giá và chính sách, khách hàng, quy trình, con người, bằng chứng và câu chuyện, địa điểm và kênh liên hệ). Câu trả lời được đưa vào mọi prompt như dữ kiện được phép dùng (lập kế hoạch, viết, biên tập, kiểm duyệt), nên bài viết và FAQ dựa trên dữ liệu thật thay vì suy đoán. Nút "Lưu và cập nhật Entity bằng AI" rút tên pháp lý, mô tả, năm thành lập, điện thoại, email, địa chỉ, giờ mở cửa, khu vực phục vụ, mạng xã hội, tác giả vào Entity SEO (chỉ điền ô trống; có lựa chọn ghi đè), rồi dựng lại.
- **Cổng kiểm duyệt chất lượng**: mỗi trang sau khi AI viết và biên tập phải qua kiểm tra tự động (độ dài tối thiểu theo loại trang, heading và đoạn văn lặp, câu sáo rỗng, khẳng định quảng cáo không bằng chứng, nhồi từ khóa, title/meta) và AI duyệt (dữ kiện ngoài brief, trả lời đúng nhu cầu, trùng ý, đúng kiểu viết). Không đạt thì biên tập lại một lần theo danh sách lỗi; vẫn không đạt thì trang ở trạng thái "Chưa đạt", không dựng và không vào sitemap. Trong Nội dung, xem lỗi ở chi tiết trang, sửa bằng Chỉnh sửa trực quan, bấm "Duyệt và đăng" hoặc "Sinh lại". Trang chủ chưa đạt thì bước dựng website dừng và báo rõ.
